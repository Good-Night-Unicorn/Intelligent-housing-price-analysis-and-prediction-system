...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spiderze45y13i && scrapy crawl "+tableName+"Spider -a databaseName=django9166ra6h"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=django9166ra6h"
        os.system(cmd)

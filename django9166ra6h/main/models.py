...
class guangzhouxf(BaseModel):
    __doc__ = u'''guangzhouxf'''
    __tablename__ = 'guangzhouxf'
    ...
    avgprice=models.FloatField   (  null=True, unique=False, verbose_name='均价(元/平)' )
    jianmian=models.CharField ( max_length=255, null=True, unique=False, verbose_name='建面' )
    housetype=models.CharField ( max_length=255, null=True, unique=False, verbose_name='类型' )
    opendate=models.CharField ( max_length=255, null=True, unique=False, verbose_name='最新开盘' )
    tagname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='标签' )
    totalprice=models.FloatField   (  null=True, unique=False, verbose_name='总价(万/套)' )
    properright=models.CharField ( max_length=255, null=True, unique=False, verbose_name='产权' )
    ...
    '''
    class Meta:
        db_table = 'guangzhouxf'
        verbose_name = verbose_name_plural = '广州新房'
class guangzhouxfforecast(BaseModel):
    __doc__ = u'''guangzhouxfforecast'''
    __tablename__ = 'guangzhouxfforecast'
    ...
    '''
    class Meta:
        db_table = 'guangzhouxfforecast'
        verbose_name = verbose_name_plural = '线性回归预测'
class newstype(BaseModel):
    ...
    class Meta:
        db_table = 'newstype'
        verbose_name = verbose_name_plural = '房价资讯分类'
class news(BaseModel):
    ...
    class Meta:
        db_table = 'news'
        verbose_name = verbose_name_plural = '房价资讯'

<template>
	<div class="home-content">
		...
		<div class="statis-box">
			<div id="statis1" class="statis1 animate__animated" v-if="isAuth('guangzhouxf','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-zhangjie8"></span>
				</div>
				<div class="right">
					<div class="num">{{guangzhouxfCount}}</div>
					<div class="name">广州新房总数</div>
				</div>
			</div>
		</div>
		<!-- statis -->
		...
		<!-- 5 -->
		<div class="type5">
			<div id="guangzhouxfChart1" class="echarts1 animate__animated" v-if="isAuth('guangzhouxf','首页统计')"></div>
			<div id="guangzhouxfChart2" class="echarts2 animate__animated" v-if="isAuth('guangzhouxf','首页统计')"></div>
			<div id="guangzhouxfChart3" class="echarts3 animate__animated" v-if="isAuth('guangzhouxf','首页统计')"></div>
			<div id="guangzhouxfChart4" class="echarts4 animate__animated" v-if="isAuth('guangzhouxf','首页统计')"></div>
			<div id="guangzhouxfChart5" class="echarts5 animate__animated" v-if="isAuth('guangzhouxf','首页统计')"></div>
		</div>
	</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		if(this.isAuth('guangzhouxf','首页统计')){
	...
	methods:{
		handleScroll() {
			let arr = [
				...
				{id:'guangzhouxfChart1',css:'animate__fadeInLeft'},
				{id:'guangzhouxfChart2',css:'animate__fadeInUp'},
				{id:'guangzhouxfChart3',css:'animate__fadeInLeft'},
				{id:'guangzhouxfChart4',css:'animate__fadeInRight'},
				{id:'guangzhouxfChart5',css:'animate__fadeInUp'},
			]
